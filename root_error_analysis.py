...
fit_result = graph.Fit("exponential_fit", "RS")  # "RS" for range fit and storing fit result
...
parameter_errors = [fit_result.Error(i) for i in range(2)]  # Access parameter errors
print("Fit parameters:", parameters)
print("Parameter errors:", parameter_errors)
...
# Parameter errors: [14.12390679360543, 0.0007014851489273396]
...
# execution time: 1.6461249719141051
